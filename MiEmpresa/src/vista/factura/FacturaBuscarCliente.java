...
public class FacturaBuscarCliente extends javax.swing.JDialog {
    
    static ResultSet rs;
    static int idCliente;

    public FacturaBuscarCliente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ConfigurarVentana();
        CargarClientes();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FacturaBuscarCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FacturaBuscarCliente dialog = new FacturaBuscarCliente(new javax.swing.JFrame(), true);
